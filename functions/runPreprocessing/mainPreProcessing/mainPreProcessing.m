function [bipolar_eeg , indexofcleandata] = mainPreProcessing(P,settings,raw_data,params, labels, gyri, hopID)
...
clearvars -except P settings raw_data params labels gyri hopID
...
switch hopID
    case 'Houston'
        ...
        clear c strCR strDotsMaximum strPercentageLength
        ...
        spottedChannels_positive = find(dataVariance > (detectionThreshold * median(dataVariance)));
        spottedChannels_negative = find(dataVariance < (median(dataVariance)/detectionThreshold));
        ...
        elseif strcmp(user_response,'Y')
            ...
            error('Please only add numerical values')
        end
        ...
        disp([newline...
            '---------------- Intiating Stage 3 of the analysis ---------------- ' ...
            newline ...
            '(Rejection of channels based on deviation on the detection of HFOs)'...
            newline])
        ...
        [pathological_chan_id,pathological_event, bipolar_eeg] = ...
